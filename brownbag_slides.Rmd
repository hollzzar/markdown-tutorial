...
- [Rmd > knitr > md > pandoc > output](https://stackoverflow.com/questions/40563479/relationship-between-r-markdown-knitr-pandoc-and-bookdown)
...
- Bibiography style: .csl (see my [CV](https://github.com/hollzzar/zaharchuk-cv) and [Psychonomics poster](https://github.com/hollzzar/psychonomics-poster) repos)
- $\LaTeX$ styling: .cls
- HTML styling: .css
