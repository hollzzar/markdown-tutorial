...
2. Practice activity or beginner R
3. Continuing practice activity or intermediate/advanced R
...
- Pattern matching
  - Find a pattern: `grep()`, `grepl()`, `agrep()`, `agrepl()`, `str_detect()`, etc.
  - Find and change a pattern: `sub()`, `gsub()`, `replace()`, etc.
